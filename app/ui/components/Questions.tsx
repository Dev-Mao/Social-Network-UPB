...
export default function QuestionsList() {
  ...
  const handleQuestions = (question: string) => {
    setOpenQuestions(
      openQuestions.includes(question)
        ? openQuestions.filter((openQuestion) => openQuestion !== question)
          ...
          <li key={index}>
            ...
            >
              <Image
                ...
                priority={true}
                className={`drop-down
                ${openQuestions.includes(title) && " open"}`}
              />
            </div>
            {openQuestions.includes(title) && <p>{content}</p>}
          </li>
        ))}
      </ul>
      <SignifierScroll containerId="container-questions" />
    </section>
  );
}
